...
class FaceRecognition:
    ...
    def RecognizeFaces(self, face_roi, face_x_max, face_y_min, to_putting_frame):
        ...
        for (top, right, bottom, left), name in zip(face_locations, self.face_names):
            ...
            result = self.people[name]['Name']
            result2 = self.people[name]['Age']
            result3 = self.people[name]['Sex']

            cv2.rectangle(to_putting_frame, (face_x_max, face_y_min+10), (face_x_max+150, face_y_min+160), (131, 198, 255), cv2.FILLED)

            cv2.putText(to_putting_frame, result, (face_x_max+10, face_y_min+40), font, 1.0, (255, 0, 0), 1)
            cv2.putText(to_putting_frame, result2, (face_x_max+10, face_y_min+90), font, 1.0, (255, 0, 0), 1)
            cv2.putText(to_putting_frame, result3, (face_x_max+10, face_y_min+140), font, 1.0, (255, 0, 0), 1)
